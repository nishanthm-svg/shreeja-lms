...
const UI = {
  ...
  // Offline banner
  offlineBannerText: L(
    "📴 You're offline — lessons and quizzes still work. Your progress will sync once you're back online.",
    "📴 మీరు ఆఫ్‌లైన్‌లో ఉన్నారు — పాఠాలు, క్విజ్‌లు ఇంకా పనిచేస్తాయి. మీరు తిరిగి ఆన్‌లైన్‌లోకి వచ్చిన వెంటనే మీ పురోగతి సమకాలీకరించబడుతుంది.",
    "📴 நீங்கள் ஆஃப்லைனில் உள்ளீர்கள் — பாடங்களும் வினாடி வினாக்களும் இன்னும் வேலை செய்யும். மீண்டும் ஆன்லைனுக்கு வந்தவுடன் உங்கள் முன்னேற்றம் ஒத்திசைக்கப்படும்.",
    "📴 ನೀವು ಆಫ್‌ಲೈನ್‌ನಲ್ಲಿದ್ದೀರಿ — ಪಾಠಗಳು ಮತ್ತು ಕ್ವಿಜ್‌ಗಳು ಇನ್ನೂ ಕೆಲಸ ಮಾಡುತ್ತವೆ. ನೀವು ಮತ್ತೆ ಆನ್‌ಲೈನ್‌ಗೆ ಬಂದ ತಕ್ಷಣ ನಿಮ್ಮ ಪ್ರಗತಿ ಸಿಂಕ್ ಆಗುತ್ತದೆ."
  ),

  // Final exam
  examCertCardTitle: L("Final Exam Certificate", "ఫైనల్ పరీక్ష సర్టిఫికెట్", "இறுதி தேர்வு சான்றிதழ்", "ಅಂತಿಮ ಪರೀಕ್ಷೆ ಪ್ರಮಾಣಪತ್ರ"),
  examCertCardEarnedText: L(
    "Passed with a score of {score}%",
    "{score}% స్కోరుతో ఉత్తీర్ణత సాధించారు",
    "{score}% மதிப்பெண்ணுடன் தேர்ச்சி பெற்றீர்கள்",
    "{score}% ಅಂಕದೊಂದಿಗೆ ಉತ್ತೀರ್ಣರಾಗಿದ್ದೀರಿ"
  ),
  examCertCardReadyText: L(
    "All modules complete — take the final exam to earn this certificate",
    "అన్ని మాడ్యూళ్లు పూర్తయ్యాయి — ఈ సర్టిఫికెట్ పొందడానికి ఫైనల్ పరీక్ష రాయండి",
    "அனைத்து பாடங்களும் முடிந்தன — இந்த சான்றிதழைப் பெற இறுதி தேர்வை எழுதுங்கள்",
    "ಎಲ್ಲಾ ಮಾಡ್ಯೂಲ್‌ಗಳು ಪೂರ್ಣಗೊಂಡಿವೆ — ಈ ಪ್ರಮಾಣಪತ್ರ ಪಡೆಯಲು ಅಂತಿಮ ಪರೀಕ್ಷೆ ಬರೆಯಿರಿ"
  ),
  examCertCardLockedText: L(
    "Complete every module to unlock the final exam",
    "ఫైనల్ పరీక్షను అన్‌లాక్ చేయడానికి ప్రతి మాడ్యూల్‌ను పూర్తి చేయండి",
    "இறுதி தேர்வை திறக்க ஒவ்வொரு பாடத்தையும் முடிக்கவும்",
    "ಅಂತಿಮ ಪರೀಕ್ಷೆಯನ್ನು ಅನ್‌ಲಾಕ್ ಮಾಡಲು ಪ್ರತಿ ಮಾಡ್ಯೂಲ್ ಅನ್ನು ಪೂರ್ಣಗೊಳಿಸಿ"
  ),
  examTakeButton: L("Take Final Exam →", "ఫైనల్ పరీక్ష రాయండి →", "இறுதி தேர்வை எழுதுங்கள் →", "ಅಂತಿಮ ಪರೀಕ್ಷೆ ಬರೆಯಿರಿ →"),
  certNotEarnedExamText: L(
    "Pass the final exam to earn this certificate.",
    "ఈ సర్టిఫికెట్ పొందడానికి ఫైనల్ పరీక్షలో ఉత్తీర్ణత సాధించండి.",
    "இந்த சான்றிதழைப் பெற இறுதி தேர்வில் தேர்ச்சி பெறுங்கள்.",
    "ಈ ಪ್ರಮಾಣಪತ್ರ ಪಡೆಯಲು ಅಂತಿಮ ಪರೀಕ್ಷೆಯಲ್ಲಿ ಉತ್ತೀರ್ಣರಾಗಿ."
  ),
  certTitleExam: L("Final Exam Certificate", "ఫైనల్ పరీక్ష సర్టిఫికెట్", "இறுதி தேர்வு சான்றிதழ்", "ಅಂತಿಮ ಪರೀಕ್ಷೆ ಪ್ರಮಾಣಪತ್ರ"),
  certExamBody: L(
    "has successfully passed the final examination for",
    "కోసం ఫైనల్ పరీక్షలో విజయవంతంగా ఉత్తీర్ణత సాధించారు",
    "க்கான இறுதி தேர்வில் வெற்றிகரமாக தேர்ச்சி பெற்றுள்ளார்",
    "ಗಾಗಿ ಅಂತಿಮ ಪರೀಕ್ಷೆಯಲ್ಲಿ ಯಶಸ್ವಿಯಾಗಿ ಉತ್ತೀರ್ಣರಾಗಿದ್ದಾರೆ"
  ),
  examIntroTitle: L("Final Exam", "ఫైనల్ పరీక్ష", "இறுதி தேர்வு", "ಅಂತಿಮ ಪರೀಕ್ಷೆ"),
  examIntroText: L(
    "This exam covers all 12 modules with application-based questions — a bit tougher than the lesson quizzes. You need {pass}% or more to pass. You can retake it as many times as you need.",
    "ఈ పరీక్ష అన్ని 12 మాడ్యూళ్లను అప్లికేషన్-ఆధారిత ప్రశ్నలతో కవర్ చేస్తుంది — పాఠ క్విజ్‌ల కంటే కొంచెం కష్టం. ఉత్తీర్ణత సాధించడానికి మీకు {pass}% లేదా అంతకంటే ఎక్కువ అవసరం. మీకు అవసరమైనన్ని సార్లు మళ్లీ ప్రయత్నించవచ్చు.",
    "இந்த தேர்வு அனைத்து 12 பாடங்களையும் பயன்பாட்டு அடிப்படையிலான கேள்விகளுடன் உள்ளடக்கியது — பாட வினாடி வினாக்களை விட சற்று கடினமானது. தேர்ச்சி பெற உங்களுக்கு {pass}% அல்லது அதற்கு மேல் தேவை. உங்களுக்கு தேவையான அளவு முறை மீண்டும் முயற்சிக்கலாம்.",
    "ಈ ಪರೀಕ್ಷೆ ಎಲ್ಲಾ 12 ಮಾಡ್ಯೂಲ್‌ಗಳನ್ನು ಅನ್ವಯಿಕ-ಆಧಾರಿತ ಪ್ರಶ್ನೆಗಳೊಂದಿಗೆ ಒಳಗೊಂಡಿದೆ — ಪಾಠ ಕ್ವಿಜ್‌ಗಳಿಗಿಂತ ಸ್ವಲ್ಪ ಕಷ್ಟ. ಉತ್ತೀರ್ಣರಾಗಲು ನಿಮಗೆ {pass}% ಅಥವಾ ಹೆಚ್ಚು ಬೇಕು. ನಿಮಗೆ ಬೇಕಾದಷ್ಟು ಬಾರಿ ಮತ್ತೆ ಪ್ರಯತ್ನಿಸಬಹುದು."
  ),
  examStartButton: L("Start Final Exam", "ఫైనల్ పరీక్ష ప్రారంభించండి", "இறுதி தேர்வைத் தொடங்கு", "ಅಂತಿಮ ಪರೀಕ್ಷೆ ಪ್ರಾರಂಭಿಸಿ"),
  examSubmitButton: L("Submit Exam", "పరీక్ష సమర్పించండి", "தேர்வைச் சமர்ப்பிக்கவும்", "ಪರೀಕ್ಷೆ ಸಲ್ಲಿಸಿ"),
  examPassTitle: L("🎉 You Passed!", "🎉 మీరు ఉత్తీర్ణత సాధించారు!", "🎉 நீங்கள் தேர்ச்சி பெற்றீர்கள்!", "🎉 ನೀವು ಉತ್ತೀರ್ಣರಾಗಿದ್ದೀರಿ!"),
  examPassText: L(
    "Great work — you've passed the final exam and earned your Final Exam Certificate.",
    "అద్భుతం — మీరు ఫైనల్ పరీక్షలో ఉత్తీర్ణత సాధించి మీ ఫైనల్ పరీక్ష సర్టిఫికెట్ పొందారు.",
    "அருமை — நீங்கள் இறுதி தேர்வில் தேர்ச்சி பெற்று உங்கள் இறுதி தேர்வு சான்றிதழைப் பெற்றுள்ளீர்கள்.",
    "ಅದ್ಭುತ — ನೀವು ಅಂತಿಮ ಪರೀಕ್ಷೆಯಲ್ಲಿ ಉತ್ತೀರ್ಣರಾಗಿ ನಿಮ್ಮ ಅಂತಿಮ ಪರೀಕ್ಷೆ ಪ್ರಮಾಣಪತ್ರ ಪಡೆದಿದ್ದೀರಿ."
  ),
  examFailTitle: L("Not Quite Yet", "ఇంకా కాలేదు", "இன்னும் இல்லை", "ಇನ್ನೂ ಇಲ್ಲ"),
  examFailText: L(
    "You didn't reach the passing score this time — review the answers below, then try again whenever you're ready.",
    "ఈసారి మీరు ఉత్తీర్ణత స్కోరును చేరుకోలేదు — దిగువ సమాధానాలను సమీక్షించి, మీరు సిద్ధమైనప్పుడు మళ్లీ ప్రయత్నించండి.",
    "இந்த முறை நீங்கள் தேர்ச்சி மதிப்பெண்ணை அடையவில்லை — கீழே உள்ள பதில்களை மறுபரிசீலனை செய்து, நீங்கள் தயாராக இருக்கும்போது மீண்டும் முயற்சிக்கவும்.",
    "ಈ ಬಾರಿ ನೀವು ಉತ್ತೀರ್ಣ ಅಂಕವನ್ನು ತಲುಪಲಿಲ್ಲ — ಕೆಳಗಿನ ಉತ್ತರಗಳನ್ನು ಪರಿಶೀಲಿಸಿ, ನೀವು ಸಿದ್ಧರಾದಾಗ ಮತ್ತೆ ಪ್ರಯತ್ನಿಸಿ."
  ),
  examScoreLabel: L("Your score: {score}%", "మీ స్కోరు: {score}%", "உங்கள் மதிப்பெண்: {score}%", "ನಿಮ್ಮ ಅಂಕ: {score}%"),
  examRetakeButton: L("Try Again", "మళ్లీ ప్రయత్నించండి", "மீண்டும் முயற்சிக்கவும்", "ಮತ್ತೆ ಪ್ರಯತ್ನಿಸಿ"),
  examViewCertificateButton: L("🎓 View Certificate", "🎓 సర్టిఫికెట్ చూడండి", "🎓 சான்றிதழைப் பார்க்கவும்", "🎓 ಪ್ರಮಾಣಪತ್ರ ವೀಕ್ಷಿಸಿ"),
  examNotUnlockedText: L(
    "Complete every module before taking the final exam.",
    "ఫైనల్ పరీక్ష రాయడానికి ముందు ప్రతి మాడ్యూల్‌ను పూర్తి చేయండి.",
    "இறுதி தேர்வை எழுதுவதற்கு முன் ஒவ்வொரு பாடத்தையும் முடிக்கவும்.",
    "ಅಂತಿಮ ಪರೀಕ್ಷೆ ಬರೆಯುವ ಮೊದಲು ಪ್ರತಿ ಮಾಡ್ಯೂಲ್ ಅನ್ನು ಪೂರ್ಣಗೊಳಿಸಿ."
  ),
  adminExamColumnLabel: L("Final Exam", "ఫైనల్ పరీక్ష", "இறுதி தேர்வு", "ಅಂತಿಮ ಪರೀಕ್ಷೆ"),
